...
export const metadata: Metadata = { title: "Advertise — BestBabyRank", description: "Advertise with BestBabyRank and reach a targeted audience interested in baby products and parenting." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on BestBabyRank</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing baby products and parenting. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@bestbabyrank.com">hello@bestbabyrank.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
